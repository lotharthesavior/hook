 ...
 * Class HooksTest
 */
class HooksStrictTest extends TestCase
{
    ...
    {
        Filter::addFilter('test_strict', [$this, 'hookTestString1']);
        Filter::addFilter('test_strict', [$this, 'hookTestString2']);

        $lall = Filter::applyFilters('test_strict', '');
    ...
    public function testRunHookFunctions()
    {
        ...
        self::assertSame(2, Action::didAction('testAction'));
        self::assertSame(true, Action::doAction('testAction'));
        self::assertSame(3, Action::didAction('testAction'));
        self::assertSame('foo', Filter::applyFilters('testFilter', 'Foo'));
    ...
    public function testRunShortcodeFunctions()
    {
        ...
        self::assertSame('foo bar ', Shortcode::stripShortcodes('foo bar [testAction foo="bar"]content[/testAction]'));
